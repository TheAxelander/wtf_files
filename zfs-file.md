...
| `zfs get compressratio datapool/fs1` | Get deduplication ratios for fs1 |
| `zpool get dedupratio datapool` | Get deduplication ratios for datapool |
...
| `zfs set dedup=on datapool/fs1` | Enable deduplication on fs1 |
